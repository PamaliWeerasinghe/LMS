...
<body style="margin: 0px; background-color: #FFFFE0;">
    ...
    <a href="index.php" style="color: black;"><i class="bi bi-arrow-left-short fs-2"></i></a>
        ...
        <div class="row align-content-center " style="margin-top:1vh;margin-left:6%;width:87%; height:80vh;background-color: white; border-radius:35px;box-shadow: 0px 0px 0px 0px rgb(255, 191, 0), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
        ...
        <div class="col-lg-6 col-12 i1" >
            <!-- <img src="Thesis.gif" style="width:650px; height:580px"/> -->
        </div>
        <div class="col-lg-6 col-12">
            ...
            <div class="row">
                <input type="text" class="form-control" style="width:96%;margin-left:11px;" id="Academicusername"/>
            </div>
            <div class="row mt-3">
            ...
            <div class="row">
                <div class="input-group mb-3">
                    <input type="password" class="form-control" aria-label="Recipient's username"id="Academicpassword" aria-describedby="button-addon2" style="width:75%">
                    <button class="btn btn-outline border" type="button" id="button-addon2"><i class="bi bi-eye-slash"onclick="aceye();" id="eye" ></i></button>
                </div>
            </div>
         
            <div class="row mt-4 ">
                <div class="col-lg-12 d-grid"><button class="btn btn-danger" onclick="loginAcademic();">Log In</button></div>
            </div>
