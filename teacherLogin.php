...
<body style="margin: 0px; background-color: #FFFFE0;">
    ...
    <a href="index.php" style="color: black;"><i class="bi bi-arrow-left-short fs-2"></i></a>
        ...
        <div class="col-lg-6 col-12">
            ...
            <div class="row">
                <input type="text" class="form-control" style="width:96%;margin-left:11px;" id="username"/>
            </div>
            <div class="row mt-3">
            ...
            <div class="row">
                <div class="input-group mb-3">
                    <input type="password" class="form-control" aria-label="Recipient's username" id="password" aria-describedby="button-addon2" style="width:75%">
                    <button class="btn btn-outline border" type="button" id="button-addon2"><i class="bi bi-eye-slash" onclick="eye();" id="eye" ></i></button>
                </div>
            </div>
           
            <div class="row mt-4 ">
                <div class="col-lg-12 d-grid"><button class="btn btn-danger" onclick="login();">Log In</button></div>
            </div>
