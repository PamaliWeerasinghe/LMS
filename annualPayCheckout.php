...
if($payid===''){echo "<script> alert('Unknown Error Occured on selecting payment method');location='annualPay.php' </script>";die();}
                    ...
                    <tr>
                        <th class="col2_1">
                            ...
                            <a class="backButton-anchor">
                                <button  onclick="window.location='annualPay.php'" class="backButton">Back</button>
                            </a>
                        </th>
                    </tr>
                </tbody>
                ...
                <div class="box-product-body">
                        ...
                        <div class="box-product-body-inner">
                            <div class="product-details">
                                <form class="data-input-form" method="post" action="annualoutAction.php">
                                                                        <br/>
                                                                        <br/>
                                    ...
                                    <br/>
                                    <div class="btns">
                                    <button  type="submit" class="btn-purchase">Pay&nbsp;LKR&nbsp;<?php echo "10000" ?>.00</button>&nbsp;&nbsp;
                                    <button class="btn-purchase" onclick="window.location='AnnualPay.php'">BACK</button>
                                    </div>
                                </form>
