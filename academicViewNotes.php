                        ...
                        <div class="row d-none" id="insideDetails<?php echo $lessons_data['id']; ?>">
                            <div class="col-12" style="margin-left: 10%;" >
                             <table class="border-bottom" style="width:90%">
                                <tr>
                                    <td style="color:grey" class="border"><label class="form-label">Note title</label></td>
                                ...
                                <?php 
                                 $notes=Database::search("SELECT * FROM `lesson_notes` WHERE `lessons_id`='".$lessons_data["id"]."'");
                                 $notes_num=$notes->num_rows;
                                 //echo($assignment_num);
                                 for($z=0;$z<$notes_num;$z++){
                                    $note_data=$notes->fetch_assoc(); 
                                ...
                                <tr class="border-bottom">
                                                ...
                                                <?php 
                                                $nt=Database::search("SELECT * FROM `teacher` WHERE `id`='".$note_data["teacher_id"]."'");
                                                $nt_data=$nt->fetch_assoc();
                                                ?>
                                               
                                                <td class="mt-2 mb-3"><?php echo $nt_data["fname"]?>&nbsp;<?php echo $nt_data["lname"]?></td>
                                                <td class="mt-2 mb-3"><a href="<?php echo $note_data["path"];?>" class="btn btn-warning" style="width:80%">View</a></td>
